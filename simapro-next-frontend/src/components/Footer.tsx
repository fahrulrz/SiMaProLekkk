...
const Footer: React.FC = () => {
  return (
    <div className="bg-primary h-96 px-24 pt-24 justify-between flex flex-col">
      <div className="flex flex-row justify-between text-white">
        <div className="flex w-1/2 pe-24">
          <p className="text-2xl tracking-wide font-medium ps-32">
        ...
        <div className="flex w-1/3 text-2xl ">
